package com.example.project_beliard.presentation.detail
...
import com.example.project_beliard.presentation.api.PokemonDetailResponse
...
class PokemonDetailFragment : Fragment() {
    ...
    private fun callAPi() {
        Singletons.countryApi.getPokemonDetail("1").enqueue(object : Callback<PokemonDetailResponse>{
